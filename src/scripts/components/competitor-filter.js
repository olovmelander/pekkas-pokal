class CompetitorMultiSelect {
  ...
  build() {
    ...
    this.input.placeholder = "Sök deltagare...";
  ...
  renderOptions() {
    ...
    const filtered = this.options.filter(
      (o) => !this.selected.has(o.id) && o.name.toLowerCase().includes(query),
    );
  ...
  renderChips() {
    ...
    if (this.selected.size === 0) {
      ...
      placeholder.textContent = "Alla Deltagare";
...
window.CompetitorMultiSelect = CompetitorMultiSelect;
